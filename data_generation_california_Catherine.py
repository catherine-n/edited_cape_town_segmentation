...
def main():
    with open("/home/cmn60/cape_town_segmentation/data/datagen_config_california.json", mode="r") as f:
        args = json.load(f)
    ...
    print("Image path exists:", os.path.exists(args["image_path"]))
    print("JSON path exists:", os.path.exists(args["json_path"]))
