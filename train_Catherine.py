...
# Paths
CP_DATA_DIR = "/home/cmn60/cape_town_segmentation/data/cape_town"
...
csv_logger = CSVLogger(save_dir="/home/cmn60/cape_town_segmentation/logs/cal_320", name='cal_320')
...
if args.mode == "train":
    ...
    model = SolarModel.load_from_checkpoint(
        checkpoint_path="/home/cmn60/cape_town_segmentation/trained_models/cal_320/epoch=39-valid_dataset_iou=0.9293.ckpt",
        arch='FPN',
...
checkpoint_callback = ModelCheckpoint(
    dirpath='/home/cmn60/cape_town_segmentation/trained_models/cal_320_new',   
